...
## ----simulation1, fig.cap="Scatterplot of team talents and wins for many season simulations."----
ggplot(Many.Results, aes(Talent, Wins)) +
  geom_point(alpha = 0.05)

## ----simulation2, fig.cap="Histogram of number of wins of teams of average talents in the simulations."----
...
## ----simulation3, fig.cap="Probability of winning the pennant and winning the World Series for teams of different talents."----
