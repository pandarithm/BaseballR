...
## ----mantle1, fig.cap="Scatterplot of OPS against age for Mickey Mantle."----
...
## ----mantle2, fig.cap="Career trajectory of OPS measure for Mickey Mantle with the peak age and maximum OPS identified from the quadratic smoothing curve."----
ggplot(Mantle, aes(Age, OPS)) + geom_point() +
...
## ----mantlegroup1, fig.cap="Estimated career trajectories for Mickey Mantle and five similar hitters."----
plot_trajectories("Mickey Mantle", 6, 2)

## ----jetergroup1, fig.cap="Estimated career trajectories for Derek Jeter and eight similar hitters."----
...
## ----jeter1, fig.cap="Estimated peak ages and curvature statistics for Derek Jeter and eight players most similar to him."----
library(ggrepel)
...
## ----peakage1, warning=FALSE, fig.cap="Scatterplot of peak age and midcareer for all players with at least 2000 career at-bats. A smoothing curve is used to see the general pattern in the scatterplot."----
...
## ----peakage2, warning=FALSE, fig.cap="Scatterplot of the logarithm of the career at-bats and peak age for all players with at least 2000 career at-bats. A smoothing curve is used to see the general pattern in the scatterplot."----
age_plot +
  aes(x = log2(AB.total)) +
...
## ----fielding1, warning=FALSE, fig.cap="Scatterplot of peak ages against primary fielding position."----
